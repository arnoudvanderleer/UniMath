  ...
  - apply ((((unit,,isasetunit) + (nat,,isasetnat)) + (nat,, isasetnat))%set).
    - intros H. induction H  as [term_construct | elim_construct].
      + induction term_construct as [abs|sum].
        * exact ((((sv :: []) ,,st) :: []),,st).
        * exact ((constant_list ([] ,, se) sum) ,, st ).
      + exact ((([],,sv) :: (constant_list ([] ,, st) elim_construct)),, se).
Defined.
...
CoproductsHSET (constant_list ([] ,, st) (S n),,se) UntypedForest_gen).
Proof.
   apply idpath.
Qed.
...
(constant_list ([] ,, st) (S n),,se) UntypedForest_gen.
Proof.
   induction n.
   - apply idpath.
...
(ContinuityOfMultiSortedSigToFunctor.hat_exp_functor_list'_optimized
sort Hsort SET TerminalHSET BinProductsHSET BinCoproductsHSET
CoproductsHSET (constant_list ([] ,, se) n,,st) UntypedForest_gen).
Proof.
   apply idpath.
Qed.
...
(ContinuityOfMultiSortedSigToFunctor.hat_exp_functor_list'_optimized
sort Hsort SET TerminalHSET BinProductsHSET BinCoproductsHSET
CoproductsHSET (constant_list ([] ,, se) (S n),,st) UntypedForest_gen).
Proof.
  induction n.
  -apply idpath.
